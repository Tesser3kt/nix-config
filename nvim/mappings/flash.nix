{
  ...
  programs.neovim.initLua = ''
    ...
    vim.keymap.set("o", "rq", "<cmd>lua require('flash').remote()<CR>", { desc = "Remote Flash" })
    vim.keymap.set({ "o", "x" }, "Ri", "<cmd>lua require('flash').treesitter_search()<CR>", { desc = "Flash treesitter search" })
